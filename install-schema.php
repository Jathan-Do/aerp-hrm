...
function aerp_hrm_seed_data()
{
    ...
    $permissions = [
        ...
        // Accouting
        ['name' => 'acc_receipt_add', 'description' => 'Thêm phiếu thu'],
        ['name' => 'acc_receipt_edit', 'description' => 'Chỉnh sửa phiếu thu'],
        ['name' => 'acc_receipt_view', 'description' => 'Xem phiếu thu'],
        ['name' => 'acc_deposit_add', 'description' => 'Thêm phiếu nộp tiền'],
        ['name' => 'acc_deposit_edit', 'description' => 'Chỉnh sửa phiếu nộp tiền'],
        ['name' => 'acc_deposit_view', 'description' => 'Xem phiếu nộp tiền'],
        ['name' => 'acc_payment_add', 'description' => 'Thêm phiếu chi'],
        ['name' => 'acc_payment_edit', 'description' => 'Chỉnh sửa phiếu chi'],
        ['name' => 'acc_payment_view', 'description' => 'Xem phiếu chi'],
    ...
    $role_permissions = [
        'admin' => [
            ...
            'customer_type_edit',
            'customer_type_view',
            'customer_source_view',
            'customer_source_edit',
            'customer_source_add',
            'order_add',
            'order_edit',
            'order_view',
