        ...
        <form method="post">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control shadow-sm" id="rank_code" name="rank_code" value="<?php echo esc_attr($editing->rank_code); ?>" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="min_point" class="form-label">Từ điểm</label>
                    <input type="number" class="form-control shadow-sm" id="min_point" name="min_point" min="0" value="<?php echo esc_attr($editing->min_point); ?>" required>
                </div>
                <div class="col-md-6 mb-3">
