...
$access_conditions = [
    ...
    aerp_user_has_permission($user_id, 'attendance_edit'),
];
...
if (function_exists('aerp_render_breadcrumb')) {
    aerp_render_breadcrumb([
        ...
        ['label' => 'Chi tiết nhân viên', 'url' => home_url('/aerp-hrm-employees/?action=view&id=' . $employee_id . '&section=attendance')],
        ['label' => 'Sửa chấm công']
    ]);
}
?>
