        ...
        <form method="post">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control shadow-sm" id="min_score" name="min_score" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="reward_amount" class="form-label">Tiền thưởng</label>
                    <input type="number" class="form-control shadow-sm" id="reward_amount" name="reward_amount" required>
                </div>
